...
mkdir -p out/msa_sched
sbatch -c 1 --mem="20G" --qos="seqbio" -p "seqbio" -A "seqbio" --job-name="msa_sched" --output=out/msa_sched/%j.out --error=out/msa_sched/%j.err ./scripts/pasteur_msa_scheduler.sh
