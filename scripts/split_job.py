...
def mol_sizes(directory, filenames):
    sizes = {}
...
def split_directory(dirpath, num_files, subdir_prefix="split_", length_factor=1.1):
...
if __name__ == "__main__":
    ...
    if not args.revert:
        split_directory(args.directory, args.split_num, subdir_prefix=args.subdir_prefix)
    else:
